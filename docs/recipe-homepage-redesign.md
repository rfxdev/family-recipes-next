...
| Search bar scroll behaviour                      | ❌ Rejected            | Search bar disappears too abruptly on scroll. Should remain visible for a bit longer — a grace period before sliding out of view.                                                          |
